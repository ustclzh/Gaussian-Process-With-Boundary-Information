function [ropt0,RI0,beta0,RIRes0,sigma20,SD0out,n0out,Minout,Rangeout]=BdryGPFit(Din,Yin,Noin)
%checked 3
...
function y=rb(x1,x2)
global gamma
y=max((1-(sum((x1-x2).^2))^(1/2))^floor(gamma),0);
