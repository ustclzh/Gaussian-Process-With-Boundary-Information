...
if(No==0)
    [paropt1, fval1, exitflag1]=fminunc(@Obj,[log(startalpha) log(0.91)*ones(1,d+2)],options);  
    [paropt2, fval2, exitflag2]=fminunc(@Obj,[log(startalpha) log(1.9)*ones(1,d+2)],options);
elseif(No==1)
...
elseif(No==2)
    [paropt1, fval1, exitflag1]=fminunc(@Obj,[log(startalpha)],options); 
    [paropt2, fval2, exitflag2]=fminunc(@Obj,[log(startalpha)],options);    
end
